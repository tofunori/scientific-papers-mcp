#!/usr/bin/env python
"""
Fix encoding issues and complete batch indexing of all 51 documents
"""
...
# First, fix the metadata_extractor.py encoding issue
extractor_path = Path(__file__).parent / "src/extractors/metadata_extractor.py"
content = extractor_path.read_text(encoding="utf-8", errors="replace")

# Apply fix: add errors="replace" to the open() call
...
if fixed_content != content:
    extractor_path.write_text(fixed_content, encoding="utf-8")
    print("[OK] Fixed encoding issue in metadata_extractor.py")
